...
За навигиране в приложението от точка до точка ще се построи граф и ще се имплементира алгоритъм за търсене на най-кратък път в графа. За всяко ключово място ще се създаде връх в графа (врата за зала/стая, завой, край на коридор, вход в сграда и др.)
...
## Roadmap
- [x] Имплементиране на функционалност за извличане на всички сгради от API;
- [ ] Премахване на излишни color колони от таблиците;
- [ ] Имплементиране на модул за изчертаване на обектите върху картата в Android приложението.
