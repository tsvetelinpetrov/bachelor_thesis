...
- В третия слой ще се изобразяват всички помещения в сградите спрямо посочения етаж/level. Този слой ще се насложи директно върху 2рия слой само при определен Zoom (При прекалено отдалечаване на картата помещенията се скриват).
