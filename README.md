...
Към момента са извлечени всички необходими плочки от уеб сървъра с картографските изображения на Open Street Map и са качени на сървъра в университета (http://creativecode.tu-varna.bg/mapsource/). На по-късен етап плочките ще бъдат модифицирани от дизайнери.
